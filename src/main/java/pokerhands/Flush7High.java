 ...
 */
public class Flush7High implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        if(map.entrySet().stream().filter(e -> e.getValue() == 0).count() > 2){
            ...
            if(cards.stream().allMatch(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7') && deadCards.stream().filter(e -> e.color == color && (e.value == '2'  || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7')).count() < 2) {
    ...
    public long getCountOfHandCombos(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        int cardsNeeded = 5 - (int)cards.stream().filter(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7').count();
        int cardsAvailable = 6 - (int)deadCards.stream().filter(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7').count();
        long combos;
