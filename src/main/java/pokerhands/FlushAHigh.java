 ...
 */
public class FlushAHigh implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        if(map.entrySet().stream().filter(e -> e.getValue() == 0).count() > 2){
            ...
            if(cards.stream().allMatch(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T' || e.value == 'J' || e.value == 'Q' || e.value == 'K' || e.value == 'A') && deadCards.stream().filter(e -> e.color == color && (e.value == '2'  || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T' || e.value == 'J' || e.value == 'Q' || e.value == 'K' || e.value == 'A')).count() < 9) {
    ...
    public long getCountOfHandCombos(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        int cardsNeeded = 5 - (int)cards.stream().filter(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T' || e.value == 'J' || e.value == 'Q' || e.value == 'K' || e.value == 'A').count();
        int cardsAvailable = 13 - (int)deadCards.stream().filter(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T' || e.value == 'J' || e.value == 'Q' || e.value == 'K' || e.value == 'A').count();
        long combos;
