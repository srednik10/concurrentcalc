 ...
 */
public class Poker6High implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        for(PokerCard card : deadCards){
            if(card.value == '6' || card.value == '2' || card.value == '3' || card.value == '4' || card.value == '5')
        ...
        if(cards.size() != 0){
            ...
            if (cards.stream().allMatch(e -> e.color == color && (e.value == '6' || e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5')) && deadCards.stream().noneMatch(e -> e.color == color && (e.value == '6' || e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5')))  {
                ...
                if(cards.stream().noneMatch(e -> e.value == '2')) producedDeadCards.add(new PokerCard(new StringBuilder().append('2').append(color).toString()));
