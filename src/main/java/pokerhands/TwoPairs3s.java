 ...
 */
public class TwoPairs3s implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        else if(countInCards == 1 && countInDeadCards < 3 && cards.size() < 3) {producedDeadCards.add(new PokerCard("3x"));return true;}
        else if(countInCards == 0 && countInDeadCards < 3 && cards.size() < 3) {producedDeadCards.add(new PokerCard("3x"));producedDeadCards.add(new PokerCard("3x"));return true;}
    ...
    public long getCountOfHandCombos(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        int cardsNeeded = 2 - (int) cards.stream().filter(e -> e.value == '3').count();
