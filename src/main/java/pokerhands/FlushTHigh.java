 ...
 */
public class FlushTHigh implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        if(map.entrySet().stream().filter(e -> e.getValue() == 0).count() > 2){
            ...
            if(cards.stream().allMatch(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T') && deadCards.stream().filter(e -> e.color == color && (e.value == '2'  || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T')).count() < 5) {
    ...
    public long getCountOfHandCombos(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        int cardsNeeded = 5 - (int)cards.stream().filter(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T').count();
        int cardsAvailable = 9 - (int)deadCards.stream().filter(e -> e.value == '2' || e.value == '3' || e.value == '4' || e.value == '5' || e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T').count();
        long combos;
