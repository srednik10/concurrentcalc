 ...
 */
public class PairOf7s implements PokerHand{
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        else if(countInCards == 1 && countInDeadCards < 3 && cards.size() < 5) {producedDeadCards.add(new PokerCard("7x"));return true;}
        else if(countInCards == 0 && countInDeadCards < 3 && cards.size() < 4) {producedDeadCards.add(new PokerCard("7x"));producedDeadCards.add(new PokerCard("7x"));return true;}
        else return false;
    }
