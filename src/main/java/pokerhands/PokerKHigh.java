 ...
 */
public class PokerKHigh implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        for(PokerCard card : deadCards){
            if(card.value == 'J' || card.value == 'Q' || card.value == 'K' || card.value == '9' || card.value == 'T')
        ...
        if(cards.size() != 0){
            ...
            if (cards.stream().allMatch(e -> e.color == color && (e.value == 'J' || e.value == 'Q' || e.value == 'K' || e.value == '9' || e.value == 'T')) && deadCards.stream().noneMatch(e -> e.color == color && (e.value == 'J' || e.value == 'Q' || e.value == 'K' || e.value == '9' || e.value == 'T')))  {
