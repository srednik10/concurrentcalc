 ...
 */
public class PokerTHigh implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        for(PokerCard card : deadCards){
            if(card.value == '6' || card.value == '7' || card.value == '8' || card.value == '9' || card.value == 'T')
        ...
        if(cards.size() != 0){
            ...
            if (cards.stream().allMatch(e -> e.color == color && (e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T')) && deadCards.stream().noneMatch(e -> e.color == color && (e.value == '6' || e.value == '7' || e.value == '8' || e.value == '9' || e.value == 'T'))) {
