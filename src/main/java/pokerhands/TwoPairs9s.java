 ...
 */
public class TwoPairs9s implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        else if(countInCards == 1 && countInDeadCards < 3 && cards.size() < 3) {producedDeadCards.add(new PokerCard("9x"));return true;}
        else if(countInCards == 0 && countInDeadCards < 3 && cards.size() < 3) {producedDeadCards.add(new PokerCard("9x"));producedDeadCards.add(new PokerCard("9x"));return true;}
