 ...
 */
public class Poker8High implements PokerHand {
    ...
    public boolean canMake(List<PokerCard> cards, List<PokerCard> deadCards) {
        ...
        for(PokerCard card : deadCards){
            if(card.value == '6' || card.value == '7' || card.value == '8' || card.value == '4' || card.value == '5')
        ...
        if(cards.size() != 0){
            ...
            if (cards.stream().allMatch(e -> e.color == color && (e.value == '6' || e.value == '7' || e.value == '8' || e.value == '4' || e.value == '5')) && deadCards.stream().noneMatch(e -> e.color == color && (e.value == '6' || e.value == '7' || e.value == '8' || e.value == '4' || e.value == '5')))  {
